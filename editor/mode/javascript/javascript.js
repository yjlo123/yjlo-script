...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
	...
	var keywords = function(){
		...
		function kw2(type) {return {type: type, style: "keyword-2"};}
		function kw3(type) {return {type: type, style: "builtin"};}
		var A = kw2("keyword a"), B = kw2("keyword b"), C = kw2("keyword c");
	...
	function statement(type, value) {
		...
		if (type == ":=") { register(prev_variable); }
