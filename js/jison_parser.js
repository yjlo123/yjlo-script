...
yy: {},
symbols_: {"error":2,"program":3,"statements":4,"EOF":5,"statement":6,"if":7,"(":8,"expression":9,")":10,"{":11,"}":12,"else":13,"func":14,"identifier":15,"identifiers":16,"var":17,"=":18,";":19,"rtn":20,"+":21,"-":22,"*":23,"/":24,"!":25,"%":26,"NUMBER":27,"true":28,"false":29,"DoubleQuoteString":30,"SingleQuoteString":31,"[]":32,"expressions":33,"nonemptyexpressions":34,",":35,"nonemptyidentifiers":36,"Identifier":37,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"if",8:"(",10:")",11:"{",12:"}",13:"else",14:"func",17:"var",18:"=",19:";",20:"rtn",21:"+",22:"-",23:"*",24:"/",25:"!",26:"%",27:"NUMBER",28:"true",29:"false",30:"DoubleQuoteString",31:"SingleQuoteString",32:"[]",35:",",37:"Identifier"},
...
parse: function parse(input) {
	...
	if (typeof this.yy.parseError === "func")
...
lexer.rules = [/^(?:\s+)/,/^(?:func\b)/,/^(?:rtn\b)/,/^(?:if\b)/,/^(?:new\b)/,/^(?:else\b)/,/^(?:var\b)/,/^(?:=)/,/^(?:\{)/,/^(?:\})/,/^(?:;)/,/^(?:,)/,/^(?:true\b)/,/^(?:false\b)/,/^(?:"(\\"|[^\"])*")/,/^(?:'(\\'|[^\'])*')/,/^(?:[A-Za-z_][A-Za-z0-9_]*)/,/^(?:[0-9]+(\.[0-9]+)?\b)/,/^(?:\[\])/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:!)/,/^(?:%)/,/^(?:===)/,/^(?:!==)/,/^(?:>)/,/^(?:<)/,/^(?:>=)/,/^(?:<=)/,/^(?:&&)/,/^(?:\|\|)/,/^(?:\()/,/^(?:\))/,/^(?:$)/,/^(?:.)/];
